...
function scoreChecker(score) {
  ...
  console.log(scoreChecker(90)); // Output: Selamat Anda mendapatkan Nilai A
  console.log(scoreChecker(85)); // Output: Anda mendapatkan nilai B.
  console.log(scoreChecker(73)); // Output: Anda mendapatkan nilai C.
  console.log(scoreChecker(62)); // Output: Anda mendapatkan nilai D.
  console.log(scoreChecker(45)); // Output: Anda mendapatkan nilai E. 
